...
If you want to take it up a notch, you can also use Cockroach in Grasshopper, a visual scripting language shiped with Rhinoceros® 7. [Go to the Rhino installation]({{ site.baseurl }}{% link docs/installation/rhino-installation.md %})
